...
namespace Dashboard.FlatDataTable.ViewModels
{
    public class MainViewModel
    {
        ...
        public MainViewModel()
        {
            ...
            members.Add(new Member { Number = "2", Character = "R", BgColor = (Brush)converter.ConvertFromString("#1E88E5"), Name = "Reza Alavi", Position = "Administrator", Email = "rezal1@hotmail.com", Phone = "254-451-7893" });
            members.Add(new Member { Number = "3", Character = "D", BgColor = (Brush)converter.ConvertFromString("#FF8F00"), Name = "Dennis Castillo", Position = "Coach", Email = "dent.cast@gmail.com", Phone = "125-520-0141" });
            ...
            members.Add(new Member { Number = "5", Character = "L", BgColor = (Brush)converter.ConvertFromString("#0CA678"), Name = "Lena Jones", Position = "Manager", Email = "len.off@hotmail.com", Phone = "320-658-9174" });
            ...
            members.Add(new Member { Number = "9", Character = "F", BgColor = (Brush)converter.ConvertFromString("#1E88E5"), Name = "Frank Underwook", Position = "Manager", Email = "frank@yahoo.com", Phone = "301-584-6966" });
