...
namespace ChatMessageApp.UserControls
{
    public partial class AccountMenuButton : UserControl
    {
        ...
        public static readonly DependencyProperty TitleProperty =
            DependencyProperty.Register(nameof(Title), typeof(string), typeof(AccountMenuButton));
        ...
        public static readonly DependencyProperty IsActiveProperty =
            DependencyProperty.Register(nameof(IsActive), typeof(bool), typeof(AccountMenuButton));
        ...
        public static readonly DependencyProperty GradientColor1Property =
            DependencyProperty.Register(nameof(GradientColor1), typeof(Color), typeof(AccountMenuButton));
        ...
        public static readonly DependencyProperty GradientColor2Property =
            DependencyProperty.Register(nameof(GradientColor2), typeof(Color), typeof(AccountMenuButton));
