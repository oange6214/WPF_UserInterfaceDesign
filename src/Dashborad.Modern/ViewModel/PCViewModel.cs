...
public class PCViewModel : INotifyPropertyChanged
{
    ...
    public PCViewModel()
    {
        ...
        {
            new PCItems { PCName = "Local Disk (C:)", PCImage = @"/Assets/Images/drive_icon.png" },
            new PCItems { PCName = "Local Disk (D:)", PCImage = @"/Assets/Images/drive_icon.png" },
            new PCItems { PCName = "Local Disk (E:)", PCImage = @"/Assets/Images/drive_icon.png" },
            new PCItems { PCName = "Local Disk (F:)", PCImage = @"/Assets/Images/drive_icon.png" }
        };
